                    ...
                    skyshares.rest.post('/media', data, {
                        onloadend: function (e) {
                            ...
                            var url = 'https://www.facebook.com/dialog/feed?app_id=771729846278358&display=page';
  							...
  							url += '&picture=' + encodeURIComponent('http://skyshares-walice.rhcloud.com/media/' + response.id);
            ...
            post: function () {
                ...
                if (media) {
                    ...
                    skyshares.rest.post('/media', data, {
                        onloadend: function (e) {
                            var response = skyshares.rest.parseresponse(e);
                            var url = 'http://skyshares-walice.rhcloud.com/googleplus';
                            url += '/' + encodeURIComponent(response.id);
  							...
  							if ( description.length == 0 ) {
  								description = 'Generated by SkyShares http://skyshares-walice.rhcloud.com';
  							}
