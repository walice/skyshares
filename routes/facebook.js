...
exports.post = function (db) {
    return function (req, res) {
        ...
        var login_request = facebook.endpoint.login + '?client_id=' + facebook.app_id + '&response_type=code' + '&scope=publish_actions' + '&redirect_uri=' + escape('http://skyshares-walice.rhcloud.com/facebook/callback');
    ...
    return function (req, res) {
        ...
        if (error) {
            ...
            if (access_token) {
                ...
                facebook_oauth.getOAuthAccessToken(code, { redirect_uri: 'http://skyshares-walice.rhcloud.com/facebook/callback' }, function (error, access_token, refresh_token, results) {
                    if (error) {
						...
						var object = {
							...
							image: {
								url: 'http://skyshares-walice.rhcloud.com/facebook/media/' + skyshares_data.media_id,
								user_generated: true
							}
						};
						//
...
exports.get = function (db) {
    return function (req, res) {
    	var variables = {
			...
			url: 'http://skyshares-walice.rhcloud.com/facebook/' + req.params.id,
			type: 'website',
